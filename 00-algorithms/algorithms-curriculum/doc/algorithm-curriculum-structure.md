# ☀️ Algorithm Curriculum Structure
...
| **학습 포맷** | All-in-One 형식 (💡→🧾→📌→🌱→📒→🐞→🔁) |
| **작성 언어** | Java (손코딩 원칙) |
| **온이 역할** | 개념 강의 + 문제 풀이 + 전략 설계 + 코드 리뷰 |
| **새봄 역할** | 직접 구현, 사고 구조 학습, 오답/질문 기록 |
...
| **복습 방식** | 개념 요약 + 사고 질문 복기 + 유사 문제 재풀이 |

---

## 🧩 Ⅳ. Phase 0 vs Phase 1~5 비교표

| 구분 | Phase 0 | Phase 1~5 |
|------|----------|-----------|
| 학습 목표 | 문법 체화 | 알고리즘 사고력 |
| 중심 포맷 | 문법 요약형 All-in-One | 교재형 확장 All-in-One |
| 개념 설명 | 단문 중심 | 인강 수준 서술형 |
| 예시 코드 | 단순 문법 예제 | 전략·시간복잡도 포함 |
| 사고 유도 | X | 사고 질문 / 반례 생성 / 시각화 포함 |
| 실수 포인트 | 오타·문법 | 논리·설계 실수 |
| 복습 방식 | 반복 손코딩 | 개념 복기 + 재설계 연습 |
...
| 역할 | 설명 |
|------|------|
| **새봄 (Learner)** | 손코딩 중심 구현, 사고 루틴 훈련, 개념을 자기 언어로 설명 가능하도록 학습 |
| **온이 (Tutor)** | 개념 설명, 코드 전략 설계, 복습용 문서화, 사고 구조 피드백 제공 |
...
> Phase 0은 “손이 기억하는 문법”  
> Phase 1~5는 “머리가 이해하는 알고리즘”  
>  
> 이 둘이 결합되면, 새봄은 **‘문제를 설계하고 설명할 수 있는 개발자’** 로 성장하게 된다.  

---

🌱 **온이의 약속:**  
앞으로 모든 수업자료는 이 공식 기준을 100% 따르며,  
인강 없이도 새봄이 완전히 이해할 수 있도록  
> “비유 → 직관 → 코드 → 사고질문 → 복습 루프” 순서로 정리
